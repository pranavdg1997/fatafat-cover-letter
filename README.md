...
QUICK DISCLAIMER : This app needs you to have Python installed on your system and some very basic programming background to be able to use it seamlessly. It opens in your browser but runs on your machine, hence a functioning computer is necessary. If you feel this should be hosted online, and made available to non-programmers, the FREE solutions that exist do not guarantee privacy of your uploaded data, although there is workout which might involve some minimal financial investment.
